...
static inline uint16_t odp_be_to_cpu_16(odp_u16le_t be16)
{
...
static inline odp_u16le_t odp_cpu_to_be_16(uint16_t cpu16)
{
#if ODP_BYTE_ORDER == ODP_LITTLE_ENDIAN
 ...
 */
#define odpfsl_bswap16(x) __builtin_bswap16(x)

/*!
 * Swap bytes in a 32-bit value.
 */
#define odpfsl_bswap32(x) __builtin_bswap32(x)

/*!
 * Swap bytes in a 64-bit value.
 */
#define odpfsl_bswap64(x) __builtin_bswap64(x)
