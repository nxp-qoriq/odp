...
#define ODP_SCHED_PRIO_NORMAL   ODP_SCHED_PRIO_HIGHEST

#define ODP_SCHED_PRIO_LOWEST   ODP_SCHED_PRIO_HIGHEST

#define ODP_SCHED_PRIO_DEFAULT  ODP_SCHED_PRIO_HIGHEST
