...
struct odp_atomic_u16_s {
	volatile int16_t v; /**< Actual storage for the atomic variable */
} ODP_ALIGNED(sizeof(uint16_t)); /* Enforce alignement! */;
...
typedef struct odp_atomic_u16_s odp_atomic_u16_t;
