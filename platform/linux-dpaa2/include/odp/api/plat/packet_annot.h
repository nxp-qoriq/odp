/* Copyright (c) 2015, Freescale Semiconductor, India Pvt. Ltd
 * All rights reserved.
 *
 ...
 * @file
 *
 * ODP packet parse results - implementation internal
 */

#ifndef ODP_PACKET_ANNOT_H_
#define ODP_PACKET_ANNOT_H_
...
#define DPAA2_GET_MBUF_HW_ANNOT(buf, ptr) \
	ptr = (odp_packet_metadata_t *)buf->hw_annot
