 ...
 */
#define ODP_TM_MAX_PRIORITIES  8
 ...
 */
#define ODP_TM_MAX_SCHED_WEIGHT  248

/** The ODP_TM_MAX_TM_QUEUES constant is the largest number of tm_queues
 * that can handled by any one TM system.
 */
#define ODP_TM_MAX_TM_QUEUES  8

/** The ODP_TM_MAX_TM_NODE_SCHED_PROFILES constant is the largest number of
 * scheduler profiles.
*/
#define ODP_TM_MAX_TM_NODE_SCHED_PROFILES	8

/** The ODP_TM_MAX_TM_NODE_QUEUE_THRES_PROFILES constant is the largest
  *	number of threshold profiles.
  */
#define ODP_TM_MAX_TM_NODE_QUEUE_THRES_PROFILES	8

/** The ODP_TM_MAX_NUM_OUTPUTS constant is the largest number of outputs
  * that can be configured for any one TM system.
  */
#define ODP_TM_MAX_NUM_OUTPUTS  1

/** The ODP_TM_MAX_NUM_TM_NODES constant is the largest number of
  * tm_nodes that can be supported on LS2 platform.
  */
#define ODP_TM_MAX_NUM_TM_NODES  ODP_TM_MAX_NUM_SYSTEMS

/** The ODP_TM_MAX_NUM_TM_NODES_PER_SYSTEM constant is the largest number of
  * tm_nodes that can be in existence for any one TM system.
  */
#define ODP_TM_MAX_TM_NODES_PER_SYSTEM		1
 ...
 */
#define ODP_TM_MAX_TM_NODE_FANIN  8

/** The ODP_TM_MAX_TM_NODE_SHAPERS constant is the largest number of
 * shaper profiles.
*/
#define ODP_TM_MAX_TM_NODE_SHAPER_PROFILES  8

/** The ODP_TM_MIN_SHAPER_BW constant is the smallest amount of bandwidth that
 * can a shaper's peak or commit rate can be set to.  It is in units of bits
 * per second so that it and the ODP_TM_MAX_SHAPER_BW can both fit in 32 bits.
 */
#define ODP_TM_MIN_SHAPER_BW  (1UL * 1024UL * 1024UL)
 ...
 * so that it and the ODP_TM_MAX_SHAPER_BURST can both fit in 32 bits.
 */
 ...
 */
#define ODP_TM_MAX_SHAPER_BURST  (64 * 1024 * 8)
 ...
 */
#define ODP_TM_INVALID  (uint64_t)-1
